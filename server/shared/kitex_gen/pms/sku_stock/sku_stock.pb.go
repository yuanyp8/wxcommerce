...
func (x *BaseSkuStock) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *BaseSkuStock) GetProductId() uint64 {
	if x != nil {
		return x.ProductId
	}
	return 0
...
func (x *SkuStockListReq) GetProductId() uint64 {
	if x != nil {
		return x.ProductId
	}
	return 0
...
func (x *SkuStockDeleteReq) GetIds() []uint64 {
	if x != nil {
		return x.Ids
	}
	return nil
...
type ReleaseSkuStockLockData struct {
	...
	ProductSkuId    uint64 `protobuf:"varint,1,opt,name=ProductSkuId,proto3" json:"ProductSkuId,omitempty"`
...
func (x *ReleaseSkuStockLockData) GetProductSkuId() uint64 {
	if x != nil {
...
func (x *LockSkuStockLockData) GetProductSkuId() uint64 {
	if x != nil {
		return x.ProductSkuId
	}
	return 0
...
func (x *QuerySkuStockByProductSkuIdReq) GetProductSkuId() uint64 {
	if x != nil {
		return x.ProductSkuId
	}
	return 0
...
var file_sku_stock_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x04, 0x52, 0x02, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x50, 0x72, 0x6f, 0x64, 0x75,
	0x63, 0x74, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x50, 0x72, 0x6f, 0x64,
	...
	0x74, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x50, 0x72, 0x6f, 0x64, 0x75,
	...
	0x01, 0x20, 0x03, 0x28, 0x04, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0x28, 0x0a, 0x12, 0x53, 0x6b,
	...
	0x04, 0x52, 0x0c, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x53, 0x6b, 0x75, 0x49, 0x64, 0x12,
	...
	0x74, 0x53, 0x6b, 0x75, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0c, 0x50, 0x72,
	...
	0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0c, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
